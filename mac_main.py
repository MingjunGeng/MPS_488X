...
main_menu = {
    'title':  'Main Menu',
    'options': [
        {'type': COMMAND, 'text': ' Normal_Mode_Update', 'command': Normal_Mode_Update },
        {'type': COMMAND, 'text': ' Recovery_Mode_Update', 'command': Recovery_Mode_Update},
        {'type': COMMAND, 'text': ' Mac_Update', 'command': Mac_Update},
        {'type': COMMAND, 'text': ' Mac_Check', 'command': Mac_Check},
        ]
    }
run_menu(main_menu)
